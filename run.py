# -*- coding: utf-8 -*-
"""
Created on Wed May 27 21:08:19 2020
...
data_in = data[:,:13]
# drop dummy variable
data_in = data_in[:,[0,1,2,4,5,6,7,8,9,10,11,12]]
data_out = data[:,13]
...
# grid search
pp = ['norm', 'whiten', 'pca', 'norm+pca']
k_centers = [50,70,90,120,140]
width_methods = [None]
...
#                print("Mean over k-folds: "+ str(errs_cv[cv_i]))
            ...
            models_dropdummy2[count_model] = model
            count_model += 1
#
# look at data
modeldata = np.empty((total,2))
for i in models_dropdummy2.keys():
    print(str(i) + ': ' +str(models_dropdummy2[i]['err']))
    modeldata[i,0] = i
    modeldata[i,1] = models_dropdummy2[i]['err']
    
modeldata=modeldata[modeldata[:,1].argsort()]
models_dropdummy2[18]
models_dropdummy2[3]
models_dropdummy2[2]
models_dropdummy2[19]
models_dropdummy2[4]
models_dropdummy2[21]
models_dropdummy2[88]
